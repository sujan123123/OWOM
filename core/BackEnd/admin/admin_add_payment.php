<?php
  ...
  //register staff
		...
		if(isset($_POST['pay_hire']))
		{
            ...
            $query1="INSERT INTO instrument_payments (a_id, instrument_cat_id, instrument_id, instrument_name, instrument_type, instrument_regno, b_duration, c_name, c_natidno, p_method, p_code, p_amt, p_ref_number) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $query2="UPDATE bookings SET b_payment = ? WHERE b_id =?";

            $stmt1 = $mysqli->prepare($query1);
            $stmt2 = $mysqli->prepare($query2);

            $rc=$stmt1->bind_param('sssssssssssss',$a_id, $instrument_cat_id, $instrument_id, $instrument_name, $instrument_type, $instrument_regno, $b_duration, $c_name, $c_natidno, $p_method, $p_code, $p_amt, $p_ref_number);
