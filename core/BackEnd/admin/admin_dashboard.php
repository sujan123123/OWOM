            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Instrument types</h5>
                        <?php
            ...
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h2 class="mb-0">Percentage  Number Of instrument Per  Category</h2>
                </div>
              </div>
            </div>
            <div class="card-body">
            ...
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h2 class="mb-0"> Percentage Total Hires Per Guitar Category</h2>
                </div>
              </div>
            </div>
            <div class="card-body">
