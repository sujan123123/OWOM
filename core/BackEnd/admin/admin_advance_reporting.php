   ...
   <?php include("inc/nav.php");?>
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <?php
                                //get details of recently joined staff
                                    $ret="SELECT * FROM staff ORDER BY RAND() LIMIT 10 ";
                                    $stmt= $mysqli->prepare($ret) ;
                                    $stmt->execute() ;//ok
                                    $res=$stmt->get_result();
                                    $cnt=1;
            ...
            <div class="card col-md-12">
                <h2 class="card-header">Instruments Records</h2>
                <div class="card-body">
                    <div class="table-responsive">
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars hiring payment records
                                    $ret="SELECT * FROM instrument_payments    ORDER BY RAND() ";
                                    $stmt= $mysqli->prepare($ret) ;
                                    $stmt->execute() ;//ok
                                    $res=$stmt->get_result();
                                    $cnt=1;
