    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Select Any instrument To Book It</h2>
                <div class="card-body">
                                ...
                                <td>
                                    <?php 
                                        if($row->instrument_status == 'Available')
                                        {
                                            echo 
                                                "
                                                    <a href  ='admin_book_instrument.php?instrument_id=$row->instrument_id&instrument_regno=$row->instrument_regno&cc_id=$row->instrument_cat_id' class='badge badge-success'>
