    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Select Any instrument Hiring Request To Approve It</h2>
                <div class="card-body">
                                ...
                                <td>
                                    <?php 
                                        if($row->b_status != 'Approved')
                                        {
                                            echo 
                                                "
                                                    <a href  ='admin_approve_single_booking.php?instrument_id=$row->instrument_id&b_id=$row->b_id' class='badge badge-success'>
                                            ...
                                            else
                                            {
                                                echo 
                                                "
                                                <a href  ='admin_disaprove_bookings.php?instrument_id=$row->instrument_id&b_id=$row->b_id' class='badge badge-warning'>
