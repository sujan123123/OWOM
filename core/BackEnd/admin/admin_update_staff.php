<?php
  ...
  //register staff
		...
		if(isset($_POST['update_staff']))
		{
            ...
            $query="UPDATE staff SET s_no =?, s_name=?, s_natidno=?, s_phone=?, s_adr=?, s_email=?, s_pwd=?, s_dpic=? WHERE s_id=?";
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" style="display:none">
                                <label for="exampleInputEmail1">Staff Number</label>
                                    ...
                                    ?>
                                <input type="text" required name="s_no" value="<?php echo $alph_num;?>-<?php echo $num;?> " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
