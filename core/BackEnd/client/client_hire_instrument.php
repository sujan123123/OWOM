                                ...
                                <td>
                                    <?php 
                                        if($row->instrument_status == 'Available')
                                        {
                                            echo 
                                                "
                                                    <a href  ='client_book_instrument.php?instrument_id=$row->instrument_id&instrument_regno=$row->instrument_regno&cc_id=$row->instrument_cat_id' class='badge badge-success'>
