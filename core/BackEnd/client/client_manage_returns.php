    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Select Any Hired instrument To Return It</h2>
                <div class="card-body">
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            //get details of all cars
                                    $c_id = $_SESSION['c_id'];
                                    $ret="SELECT * FROM bookings WHERE c_id =? AND  b_instrument_return_status ='Returned'  ORDER BY RAND() ";
                            ...
                            ?>
                                ...
                                <td>
                                    ...
                                    //If Approved show in Green If Pending Red
                                        if($row->b_instrument_return_status == 'Returned')
                                        {
                                    ...
                                    <?php 
                                        //Only allow approved cars to be returned.
                                            if($row->b_status == 'Approved')
                                            {
                                                echo 
                                                "
                                                    <a href  ='staff_return_single_booking.php?instrument_id=$row->instrument_id&b_id=$row->b_id' class='badge badge-success'>
