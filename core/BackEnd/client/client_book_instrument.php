<?php
  ...
  //register staff
		...
		if(isset($_POST['book_car']))
		{
            ...
            $query="INSERT INTO bookings (c_id, cc_id, instrument_id, instrument_name, instrument_type, instrument_regno, b_duration, c_name, c_natidno, c_phone, b_number, instrument_price) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssssss',$c_id, $cc_id, $instrument_id, $instrument_name, $instrument_type, $instrument_regno, $b_duration, $c_name, $c_natidno, $c_phone, $b_number, $instrument_price);
            $stmt->execute();
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">instrument price Per Day</label>
