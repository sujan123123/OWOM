    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Select Any Approved Instruments Hire To Add Payment</h2>
                <div class="card-body">
                            ...
                            ?>
                                ...
                                //show pay button if its not paid
                                   if($row->b_payment != 'Paid')
                                   {
                                    echo 
                                        "   
                                        <a class='badge badge-success' href='client_add_payment.php?b_id=$row->b_id&instrument_cat_id=$row->cc_id&instrument_id=$row->instrument_id'>
