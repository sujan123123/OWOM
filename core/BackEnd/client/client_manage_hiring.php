    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Manage My instrument Hiring Records.</h2>
                <div class="card-body">
                                ...
                                <td>
                                    <?php 
                                        if($row->b_status != 'Approved')
                                        {
                                            echo 
                                                "
                                                <a href  ='client_cancel_bookings.php?instrument_id=$row->instrument_id&b_id=$row->b_id' class='badge badge-warning'>
                                    ...
                                    <a href  ='client_view_bookings.php?instrument_id=<?php echo $row->instrument_id;?>&b_id=<?php echo $row->b_id;?>' class='badge badge-primary'>
