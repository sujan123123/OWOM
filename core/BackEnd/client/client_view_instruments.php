    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">View Instruments</h2>
                <div class="card-body">
                    ...
                    <!-- Projects table -->
                        <table class="table align-items-center table-flush">
                            ...
                            ?>
                                ...
                                <td>
                                        <a href  ="client_view_instrument.php?instrument_id=<?php echo $row->instrument_id;?>&instrument_regno=<?php echo $row->instrument_regno;?>" class="badge badge-success">
                                            <i class="fa fa-eye"></i>
                                                View
                                        </a>
