<?php
  ...
  //register staff
		...
		{
            $c_id = $_SESSION['c_id'];
            $instrument_cat_id = $_GET['instrument_cat_id'];
            ...
            $query1="INSERT INTO instrument_payments (c_id, instrument_cat_id, instrument_id, instrument_name, instrument_type, instrument_regno, b_duration, c_name, c_natidno, p_method, p_code, p_amt, p_ref_number) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
            $query2="UPDATE bookings SET b_payment = ? WHERE b_id =?";

            $stmt1 = $mysqli->prepare($query1);
            $stmt2 = $mysqli->prepare($query2);

            $rc=$stmt1->bind_param('sssssssssssss',$c_id, $instrument_cat_id, $instrument_id, $instrument_name, $instrument_type, $instrument_regno, $b_duration, $c_name, $c_natidno, $p_method, $p_code, $p_amt, $p_ref_number);
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header">Pay  <?php echo $row->instrument_name;?> Hire</h2>
                <div class="card-body">
                    <!--Form-->
                    <form method="post" enctype="multipart/form-data" >
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">ype</label>
                            ...
                            <div class="form-group col-md-6" style="display:none">
                                <label for="exampleInputEmail1">Payment Code</label>
                                    ...
                                    ?>
                                <input type="text" required name="p_code" value="<?php echo $alph_num;?>-<?php echo $num;?> " class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" readonly value="<?php echo $row->instrument_price;?>" required  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Price for <?php echo $row->b_duration;?> Days</label>
                                <?php
                                    $total_price = ($row->b_duration) * ($row->instrument_price);
                                ?>
