<?php
  ...
  $s_id = $_SESSION['s_id'];
		...
		if(isset($_POST['conf_book_car']))
		{
            ...
            if($stmt1 && $stmt2)
            {
                      $success = "instrument  hiring request approved";
    ...
    <div class="container-fluid mt--7">
        ...
        <div class="row">
            <div class="card col-md-12">
                <h2 class="card-header"><?php echo $row->instrument_name;?></h2>
                <div class="card-body">
                    <!--Form-->
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" required readonly name="instrument_status" readonly value="Hired" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        ...
                        <?php }?>
                        <button type="submit" name="conf_book_car" class="btn btn-outline-success">Approve Hiring</button>
                    </form>
                    <!-- ./ Form -->
                </div>    
            </div>
