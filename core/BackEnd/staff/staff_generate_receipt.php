  ...
  <div class="main-content">
   ...
   <?php include("inc/nav.php");?>
    ...
    <?php
        ...
        $p_id = $_GET['p_id'];
        $ret="SELECT  * FROM  instrument_payments  WHERE p_id=?";
                        ...
                        <main>
                            <div class="row contacts">
                                ...
                                <div class="col invoice-details">
                                    <h1 class="invoice-id">Receipt No. <?php echo $row->p_id;?></h1>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right">Instrument Registration Number</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-left"><?php echo $row->instrument_name;?></td>
                                        <td class="text-right"><?php echo $row->instrument_regno;?></td>
                                        <td class="text-right"><?php echo $row->p_method;?></td>
                                        <td class="text-right"><?php echo $row->p_ref_number;?></td>
                                        <td class="text-right">Nrs_<?php echo $row->p_amt;?></td>
                                        <?php
                                            //simple tax math
                                            $vat_tax = 0.16;
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>Nrs_ <?php echo $without_tax;?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td colspan="2">TAX 16%</td>
                                        <td>Nrs_ <?php echo $tax;?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td colspan="2">GRAND TOTAL</td>
                                        <td>Nrs_ <?php echo $taxable_payment;?></td>
                                    </tr>
                                </tfoot>
                            </table>
                            ...
                            <div class="notices">
                                <div>NOTICE:</div>
                                <div class="notice">A finance charge of 1.5% will be made on unpaid balances or delayed instrument returns after the given days.</div>
                            </div>
                        </main>
                        <footer>
