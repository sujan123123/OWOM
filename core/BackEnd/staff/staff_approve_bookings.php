                                ...
                                <td>
                                    <?php 
                                        if($row->b_status != 'Approved')
                                        {
                                            echo 
                                                "
                                                    <a href  ='staff_approve_single_booking.php?instrument_id=$row->instrument_id&b_id=$row->b_id' class='badge badge-success'>
                                            ...
                                            else
                                            {
                                                echo 
                                                "
                                                <a href  ='staff_disaprove_bookings.php?instrument_id=$row->instrument_id&b_id=$row->b_id' class='badge badge-warning'>
